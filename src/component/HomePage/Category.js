                ...
                <div className="row">
                    {data.isLoading ? (
                        ...
                        {storeCategoryData.map((item, i) => {
                                ...
                                return (
                                    <div className="col-xs-4 col-sm-4 col-md-4 col-lg-4 mb-3" key={i}>
                                            ...
                                            <div className="p-4">
                                                ...
                                                <Link state={location.pathname} to={"/" +(delivery_city).replace(/\s/g, "-").toLowerCase()+"/" +(item.category_name + " home delivery").replace(/\s/g, "-").toLowerCase() + "/" + item.id + "/" + item.category_name}>
                                                    ...
                                                    src={item.category_image} 
                                                        alt={item.category_name + " in  "+(delivery_city)+" | "+(website_name)}
                                                        title={item.category_name + " delivery in  "+(delivery_city)+" | "+(website_name)}
